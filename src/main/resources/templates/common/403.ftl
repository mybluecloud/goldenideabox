...
<html lang="en">
    ...
    <head>
        ...
        <link href="./layouts/layout/backstage/css/google-fonts.css" rel="stylesheet" type="text/css" />
        ...
        <link href="../static/pages/css/error.min.css" rel="stylesheet" type="text/css" />
