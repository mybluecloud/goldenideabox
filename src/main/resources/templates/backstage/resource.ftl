              ...
              <div class="portlet light ">
                <div class="portlet-title">
                  <div class="caption font-blue-madison">
                    ...
                    <span class="caption-subject bold uppercase">资源管理</span>
                  </div>
                  <div class="actions">
                    <div class="btn-group btn-group-devided" data-toggle="buttons">

                      <button type="button" class="btn  blue-madison btn-outline btn-circle btn-sm"
                              data-toggle="modal" onclick="newResource()">
                ...
                <div class="portlet-body">
                  ...
                  <!-- 新建编辑资源对话框 begin-->
                  <div id="resource_dialog" class="portlet box blue-hoki modal fade in">
                    <div class="portlet-title">
                      ...
                      <form action="#" class="form-horizontal">
                        ...
                        <div class="form-body">
                          <div class="form-group">
                            ...
                            <div class="col-md-6">
                              <input id="resources_id" type="hidden" class="form-control" value="0">
                              <input id="resources_name" type="text" class="form-control"
                                     style="width: 300px"
                                     placeholder="资源名称">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6">
                              <input id="resources_url" type="text" class="form-control"
                                     style="width: 300px"
                                     placeholder="资源路径">
                            </div>
                          </div>
                          <div class="form-group">
                            ...
                            <div class="col-md-6">
                              <input id="resources_type" type="text" class="form-control"
                                     style="width: 300px"
                                     placeholder="资源类型">
                            </div>
                          </div>
                          <div class="form-group">
                            <label class="col-md-3 control-label">父资源</label>
                            <div class="col-md-6">
                              <input id="resources_parent_url" type="text" class="form-control"
                                     style="width: 300px"
                                     placeholder="资源父路径">
                            </div>
                          </div>
                          <div class="form-group">
                            ...
                            <div class="col-md-6">
                              <select multiple="multiple" class="multi-select" id="select_role" name="select_role[]" >
                              </select>
                          ...
                          <div class="row">
                            <div class="col-md-offset-4 col-md-8">
                              <button type="submit" data-dismiss="modal"
                                      class="btn btn-circle blue-madison"
                                      onclick="save()">保存
                              </button>
...
<script src="${request.contextPath}/pages/scripts/resource.js" type="text/javascript"></script>
