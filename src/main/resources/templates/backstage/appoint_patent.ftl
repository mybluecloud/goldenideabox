              ...
              <div class="portlet light ">
                <div class="portlet-title">
                  <div class="caption font-blue-madison">
                    ...
                    <span class="caption-subject bold uppercase">案件分配</span>
                  </div>
                  <div class="actions">
                    <div class="btn-group btn-group-devided" data-toggle="buttons">

                      <button type="button" class="btn  blue-madison btn-outline btn-circle btn-sm"
                              data-toggle="modal" onclick="showUser()">
                        <i class="fa fa-qrcode"></i> 分配案件
                      </button>
                ...
                <div class="portlet-body">
                  ...
                  <!-- 分配用户列表 begin-->
                  <div id="user_dialog" class="portlet box blue-hoki modal fade">
                    <div class="portlet-title">
                      <div class="caption" id="title">选择分配人员
                          ...
                          <div class="form-actions">
                            <div class="row">
                              <div class="col-md-offset-4 col-md-8">
                                <button type="submit" data-dismiss="modal" onclick="appoint()"
                                        class="btn btn-circle blue-madison">分配
                                </button>
...
<script src="${request.contextPath}/pages/scripts/appoint.patent.js" type="text/javascript"></script>
