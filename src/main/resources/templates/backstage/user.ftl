...
<head>
  ...
  <link href="${request.contextPath}/layouts/layout/backstage/css/themes/default.css" rel="stylesheet" type="text/css"
        id="style_color"/>
  <link href="${request.contextPath}/layouts/layout/backstage/css/custom.css" rel="stylesheet" type="text/css"/>
            ...
            <div class="container-fluid">
              <div class="portlet box blue-hoki ">
                <div class="portlet-title">
                  ...
                  <div class="actions">
                      ...
                      <select class="form-control input-sm" id="state">
                        <option value="0" selected>正常用户</option>
                ...
                <div class="portlet-body">
                  ...
                  <table  class="table table-striped table-bordered table-hover table-checkable order-column" id="userlist">
                  </table>
...
<script src="${request.contextPath}/pages/scripts/user.js" type="text/javascript"></script>
