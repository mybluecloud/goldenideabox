...
<head>
  ...
  <link href="${request.contextPath}/global/plugins/sweetalert2/sweetalert2.css" rel="stylesheet" type="text/css"/>
                  ...
                  <div class="dropdown-menu theme-panel pull-right dropdown-custom hold-on-click">
                    <div class="col-md-12 col-sm-12 col-xs-12 seperator">
                      ...
                      <div class="col-md-offset-4 col-md-8" style="margin-top: 20px;">
                        <button type="button" data-dismiss="dropdown" class="btn btn-circle blue-madison" id="btnAddChart">添加
                        </button>
              ...
              <div class="page-content-inner">
                <#if (charts?size>0) >
                  ...
                  <#list charts as chart>
                    <option value="${chart.id}" tpl="${chart.templateId}" filter="${chart.filter}"
                            property1="${chart.property1}" >${chart.name}</option>
                  </#list>
                  </select>
                <#else>
                  <div class="note note-info">
                    <p>当前列表为空，请点击右侧按钮添加图表</p>
                  </div>
                </#if>
              </div>
            </div>
...
<script src="${request.contextPath}/pages/scripts/chart.js" type="text/javascript"></script>
