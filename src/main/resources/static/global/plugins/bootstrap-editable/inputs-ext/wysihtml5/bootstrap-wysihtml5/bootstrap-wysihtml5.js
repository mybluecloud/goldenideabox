!function($, wysi) {
        ...
        "emphasis": function(locale, options) {
            ...
            return "<li>" +
              "<div class='btn-group'>" +
                ...
                "<a class='btn default" + size + "' data-wysihtml5-command='deleteline' title='CTRL+D' tabindex='-1'>" + locale.emphasis.deleteline + "</a>" +
              "</div>" +
            "</li>";
        },
    ...
    var defaultOptions = $.fn.wysihtml5.defaultOptions = {
        ...
        stylesheets: [ "bootstrap-wysihtml5.css"], // (path_to_project/lib/css/wysiwyg-color.css)
        locale: "zh-CN"
    };
